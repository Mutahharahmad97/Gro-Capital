            ...
            <div className="dashboard__content dashboard__content--sm">
              <div className="sub-menu">
                <ul className="sub-menu__list">
                  ...
                  <li>
                    <Link to="/dashboard-terms" className="active">
                ...
                <article className="text">
                  ...
                  <p>
                    Welcome to www.grocap.com. The www.grocap.com website (the
                    "Site") is comprised of various web pages operated by Gro
                    Capital ("Gro Cap"). www.grocap.com is offered to you
                    conditioned on your acceptance without modification of the
                    terms, conditions, and notices contained herein (the
                    "Terms"). Your use of www.grocap.com constitutes your
                  ...
                  <p>
                    Gro Capital provides emerging and growth companies
                    opportunities to raise capital as debt and/or equity.
                  </p>

                  <h2>Privacy</h2>
                  <p>
                    Your use of www.grocap.com is subject to Gro Cap's Privacy
                  ...
                  <p>
                    Visiting www.grocap.com or sending emails to Gro Cap
                  ...
                  <p>
                    ...
                    acknowledge that Gro Cap is not responsible for third party
                  ...
                  <p>
                    Gro Cap does not knowingly collect, either online or
                    offline, personal information from persons under the age of
                    thirteen. If you are under 18, you may use www.grocap.com
                    only with permission of a parent or guardian.
                  </p>

                  <h2>Cancellation/Refund Policy</h2>
                  <p>
                    At any time prior to finalizing a contract for debt or
                    equity, a prospective customer may cancel their application.
                  </p>

                  <h2>Links to Third Party Sites/Third Party Services</h2>
                  <p>
                    www.grocap.com may contain links to other websites ("Linked
                    Sites"). The Linked Sites are not under the control of Gro
                    Cap and Gro Cap is not responsible for the contents of any
                    Linked Site, including without limitation any link contained
                    in a Linked Site, or any changes or updates to a Linked
                    Site. Gro Cap is providing these links to you only as a
                    convenience, and the inclusion of any link does not imply
                    endorsement by Gro Cap of the site or any association with
                    its operators.
                  </p>

                  <p>
                    Certain services made available via www.grocap.com are
                    delivered by third party sites and organizations. By using
                    any product, service or functionality originating from the
                    www.grocap.com domain, you hereby acknowledge and consent
                    that Gro Cap may share such information and data with any
                    third party with whom Gro Cap has a contractual relationship
                    to provide the requested product, service or functionality
                    on behalf of www.grocap.com users and customers.
                  </p>

                  <h2>No Unlawful or Prohibited Use/Intellectual Property</h2>
                  <p>
                    You are granted a non-exclusive, non-transferable, revocable
                    license to access and use www.grocap.com strictly in
                    accordance with these terms of use. As a condition of your
                    use of the Site, you warrant to Gro Cap that you will not
                    use the Site for any purpose that is unlawful or prohibited
                    ...
                    Site. You may not obtain or attempt to obtain any materials
                  ...
                  <p>
                    ...
                    and any software used on the Site, is the property of Gro
                    Cap or its suppliers and protected by copyright and other
                  ...
                  <p>
                    ...
                    in part, found on the Site. Gro Cap content is not for
                    ...
                    permission of Gro Cap and the copyright owner. You agree
                    that you do not acquire any ownership rights in any
                    protected content. We do not grant you any licenses, express
                    or implied, to the intellectual property of Gro Cap or our
                    licensors except as expressly authorized by these Terms.
                  </p>

                  <h2>Third Party Accounts</h2>
                  <p>
                    You will be able to connect your Gro Cap account to third
                    party accounts. By connecting your Gro Cap account to your
                    third party account, you acknowledge and agree that you are
                    consenting to the continuous release of information about
                    you to others (in accordance with your privacy settings on
                    those third party sites). If you do not want information
                    about you to be shared in this manner, do not use this
                    feature.
                  </p>

                  <h2>International Users</h2>
                  <p>
                    The Service is controlled, operated and administered by Gro
                    Cap from our offices within the USA. If you access the
                    Service from a location outside the USA, you are responsible
                    for compliance with all local laws. You agree that you will
                    not use the Gro Cap Content accessed through www.grocap.com
                  ...
                  <p>
                    You agree to indemnify, defend and hold harmless Gro Cap,
                    its officers, directors, employees, agents and third
                    ...
                    services, any user postings made by you, your violation of
                    any terms of this Agreement or your violation of any rights
                    of a third party, or your violation of any applicable laws,
                    rules or regulations. Gro Cap reserves the right, at its own
                  ...
                  <p>
                    ...
                    place on an individual basis; className arbitrations and
                    className/representative/collective actions are not
                    permitted. THE PARTIES AGREE THAT A PARTY MAY BRING CLAIMS
                    AGAINST THE OTHER ONLY IN EACH'S INDIVIDUAL CAPACITY, AND
                    NOT AS A PLAINTIFF OR className MEMBER IN ANY PUTATIVE
                    className, COLLECTIVE AND/ OR REPRESENTATIVE PROCEEDING,
                    SUCH AS IN THE FORM OF A PRIVATE ATTORNEY GENERAL ACTION
                    AGAINST THE OTHER. Further, unless both you and Gro Cap
                    agree otherwise, the arbitrator may not consolidate more
                    than one person's claims, and may not otherwise preside over
                    any form of a representative or className proceeding.
                  </p>
                  ...
                  <p>
                    ...
                    information herein. gro capital and/or its suppliers may
                    make improvements and/or changes in the site at any time.
                  </p>

                  <p>
                    Gro capital and/or its suppliers make no representations
                    ...
                    warranty or condition of any kind. gro capital and/or its
                  ...
                  <p>
                    ...
                    event shall gro capital and/or its suppliers be liable for
                    ...
                    or performance of the site, with the delay or inability to
                    ...
                    liability or otherwise, even if gro capital or any of its
                  ...
                  <p>
                    Gro Cap reserves the right, in its sole discretion, to
                    ...
                    by the laws of the State of Delaware and you hereby consent
                    to the exclusive jurisdiction and venue of courts in
                    Delaware in all disputes arising out of or relating to the
                  ...
                  <p>
                    ...
                    constitutes the entire agreement between the user and Gro
                    Cap with respect to the Site and it supersedes all prior or
                    contemporaneous communications and proposals, whether
                    electronic, oral or written, between the user and Gro Cap
                  ...
                  <p>
                    Gro Cap reserves the right, in its sole discretion, to
                    change the Terms under which www.grocap.com is offered. The
                    most current version of the Terms will supersede all
                    previous versions. Gro Cap encourages you to periodically
                    review the Terms to stay informed of our updates.
                  </p>

                  <h2>Contact Us</h2>
                  <p>
                    Gro Cap welcomes your questions or comments regarding the
                    Terms:
                  </p>
                </article>
              </div>
